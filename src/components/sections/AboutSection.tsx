    ...
    <section id="about" className="relative py-16 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          {/* Left Column: Specifications (4 cols) */}
          <div className="md:col-span-4 flex flex-col gap-6">
            ...
            <StickyNote
              ...
              className="w-full"
            >
              <div className="space-y-3 font-mono text-xs text-neutral-900">
                <div className="flex items-start gap-2.5 pb-2.5 border-b border-neutral-900/15">
                  <Terminal size={15} className="text-neutral-800 mt-0.5 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-2.5 pb-2.5 border-b border-neutral-900/15">
                  <Cpu size={15} className="text-neutral-800 mt-0.5 shrink-0" />
                  <div>
                    <span className="font-bold block text-neutral-700 uppercase tracking-tight text-[10px]">
                      Focus:
                    </span>
                    <span className="font-bold text-sm">Next.js, Laravel</span>
                  </div>
                </div>

                <div className="flex items-start gap-2.5">
                  <Layers size={15} className="text-neutral-800 mt-0.5 shrink-0" />
                  <div>
                    <span className="font-bold block text-neutral-700 uppercase tracking-tight text-[10px]">
                      Editor:
                    </span>
          ...
          {/* Right Column: Bio Narrative & Skills Post-its (8 cols) */}
